...
9. Anda juga dapat subscribe ke ABPindo Annoyances. Pergi ke [Variasi filter ABPindo](https://github.com/ABPindo/indonesianadblockrules#variasi-filter) dan klik Subscribe ABPindo - Annoyance. Ikuti petunjuk di gambar
...
AdGuard sendiri memiliki limitasi terhadap jumlah custom filter yang ditambahkan untuk mengikuti kompatibilitas Manifest V3. Anda dapat melihat sisa limit anda [di sini](https://adguard.com/kb/adguard-browser-extension/mv3-version/#limitations) dengan contoh seperti ini:
