...
# how to use: domains_to_unbound hosts-input.txt hosts-output.txt
...
if len(sys.argv) != 3:
	...
	print("Generating the unbound version from domains file {}...".format(sys.argv[1]))
	...
	for line in lines:
		if line.startswith("#"):
			...
			try:
				...
				outputfile.write('local-zone: "{}" always_nxdomain'.format(line.split(" ")[1]))
			except:
				# this may fail, don't crash
				pass
		else:
			outputfile.write('local-zone: "{}" always_nxdomain'.format(line))
		outputfile.write("\n")
