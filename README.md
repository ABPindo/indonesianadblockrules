...
Cara menggunakannya bisa berbeda-beda, intinya browser harus dipasang uBlock (https://github.com/gorhill/uBlock/releases) atau Adblock Plus (https://adblockplus.org/en/) dulu, restart browser jika diminta lalu pilih Easylist+ABPindo sebagai filter (sesuaikan kebutuhan) atau masukan filter ABPindo secara manual lewat option [code]https://indonesianadblockrules.googlecode.com/hg/subscriptions/abpindo.txt[/code] 
