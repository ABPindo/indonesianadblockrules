...
# ABPindo
ABPindo merupakan filter tambahan untuk melengkapi [EasyList](https://subscribe.adblockplus.org/?location=https://easylist.to/easylist/easylist.txt&title=Easylist) memblokir iklan mengganggu di situs berbahasa Indonesia dan Malaysia.

## Keuntungan
- Tampilan lebih bersih \
Kita dapat lebih fokus terhadap konten website, tanpa risih atau terganggu oleh iklan.
- Lebih cepat \
...
- Terjaga dari penipuan \
Banyaknya iklan yang membaur dengan konten atau iklan yang menyamar menjadi tombol update/download, menjadikan pengalaman berselancar rawan terkena penipuan. Dengan ABPindo setidaknya kita dapat terhindar dari penipuan.

## Cara Menggunakan dengan Ekstensi
...
## Langganan Filter utama (sintak Adblock)
...
## Variasi filter ABPindo untuk software pemblokir berbasis DNS
...
|RPZ [(BIND)](https://gitlab.isc.org/isc-projects/bind9.git)|[link](https://raw.githubusercontent.com/ABPindo/indonesianadblockrules/master/subscriptions/rpz.txt)|[link](https://raw.githubusercontent.com/ABPindo/indonesianadblockrules/master/subscriptions/rpz_annoyance.txt)|`example.com CNAME .`|
