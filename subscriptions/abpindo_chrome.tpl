msFilterList
: Expires=5
# Indonesian AdBlockRules (ABPindo) - supplement for indonesian website ++ for chrome
...
# ||kad.kaskus.us/banner/$script,image,subdocument
# ||kaskus.us/adv/$script,image,subdocument
